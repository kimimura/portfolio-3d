...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "the snake that runs ML models and backend APIs 🐍💻",
    color: "#3776ab",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Zenara Jaya",
    description: [
      "Architected and deployed an Applicant Tracking System (ATS) with automated resume parsing using Anthropic Claude API.",
      "Designed backend infrastructure with FastAPI and PostgreSQL, implementing secure data pipelines and RESTful API endpoints.",
      "Integrated computer vision libraries (docTR, face_recognition, OpenCV) for OCR-based document processing and facial recognition.",
      "Developed responsive landing page for Dynasty Chinese Restaurant.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NEXTJS,
  ...
  },
  {
    ...
    company: "Borneoinspire Training & Consultancy Sdn. Bhd.",
    description: [
      "Developed custom geolocation-based attendance tracking system with real-time check-in and location verification.",
      "Redesigned and maintained company website on WordPress, improving navigation and content management workflow.",
      "Managed content updates and collaborated with management to align website features with business objectives.",
    ],
    skills: [
      SkillNames.PYTHON,
      SkillNames.HTML,
  ...
  },
  {
    ...
    description: [
      "Processed and standardized legal case documents.",
      "Maintained quality control by cross-referencing official legal databases.",
      "Mentored new interns on company workflow and procedures.",
    ],
    skills: [],
  },
];
